...
{strip}
	{assign var="MODULE_NAME" value=$MODULE_MODEL->get('name')}
			...
			<div class="related span2 marginLeftZero mm-module-info-relation-box">
            	<div class="mobile-toggle-bt btn-group btn-group-vertical ">
                	<button type="button" class="btn pull-right" value="">Relational Module &nbsp;<i class="icon-align-justify"></i></button>
                </div>
          
				<div class="mobile-toggle-mm">
