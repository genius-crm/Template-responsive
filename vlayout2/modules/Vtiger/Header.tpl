...
<html>
	<head>
		...
		{/foreach}
         <link href="layouts/vlayout2/skins/style.css" rel="stylesheet" type="text/css" />
		...
		{* ADD  INCLUDES in JSResources.tpl - for better performance *}
	</head>

	<body data-skinpath="{$SKIN_PATH}" data-language="{$LANGUAGE}" style="font-family: "Source Sans Pro","Helvetica Neue",Helvetica,Arial,sans-serif !important;font-size: 14px !important;">
